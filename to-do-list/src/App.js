      ...
      <div className="form_design">
        <div className="tabs">
         ...
         button and grey out right icon */}
          <button
            className={listView ? "tab_btn left active" : "tab_btn left"}
            onClick={() => selectListView(true)}
          >
            <ImList className={listView ? "tab_icons" : "tab_icons disabled"} />
          </button>
          {/* if list view is false so the opposite*/}
          <button
            className={!listView ? "tab_btn right active" : "tab_btn right"}
            onClick={() => selectListView(false)}
          >
            <BsCalendarCheck
              className={listView ? "tab_icons disabled" : "tab_icons"}
            />
          </button>
        </div>
